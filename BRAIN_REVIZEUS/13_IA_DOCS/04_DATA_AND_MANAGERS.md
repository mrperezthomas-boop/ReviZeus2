---
document_id: IA_DOC_04_DATA_AND_MANAGERS
type: tech_reference
stability: stable
truth_level: certain
owner: data_layer
...
source: Brain_ReviZeus/13_IA_DOCS/03_DATA_AND_MANAGERS.md
---

# 04 — DATA & MANAGERS

## Usage IA
Référence des managers statiques, DAO Room, entités et du pattern d'accès aux données. À consulter avant toute modification de la couche persistance ou ajout de manager.
