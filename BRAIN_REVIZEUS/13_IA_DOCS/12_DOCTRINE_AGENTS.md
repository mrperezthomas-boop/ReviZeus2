---
document_id: IA_DOC_12_DOCTRINE_AGENTS
type: doctrine
stability: sacré
truth_level: certain
owner: brain_core
...
source: Brain_ReviZeus/01_REGLES_SACREES/DOCTRINE_EQUIPE_AGENTS.md
---

# 12 — DOCTRINE ÉQUIPE D'AGENTS

## Usage IA
Cadre opérationnel de l'équipe d'agents RéviZeus : qui fait quoi, dans quel ordre, avec quels droits d'écriture. Tout agent IA (automatique ou conversationnel) doit connaître sa famille (A = automatique locale ; B = pilotée par Claude) et respecter les zones d'écriture autorisées.
