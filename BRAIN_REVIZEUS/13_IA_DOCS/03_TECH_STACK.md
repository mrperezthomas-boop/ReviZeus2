---
document_id: IA_DOC_03_TECH_STACK
type: tech_reference
stability: stable
truth_level: certain
owner: tech_core
...
sources:
  - Brain_ReviZeus/13_IA_DOCS/02_BUILD_AND_TECH_STACK.md
  - Brain_ReviZeus/01_REGLES_SACREES/REVIZEUS_CONTEXT.md
---

# 03 — STACK TECHNIQUE & CONFIGURATION

## Usage IA
**Avant de proposer du code**, vérifie que tu respectes strictement les versions et interdictions ci-dessous. Une proposition qui violerait une de ces contraintes doit être reformulée. Ne jamais suggérer de mise à jour de version sans instruction explicite.
