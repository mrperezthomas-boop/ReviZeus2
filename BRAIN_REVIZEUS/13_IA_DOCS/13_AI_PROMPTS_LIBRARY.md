---
document_id: IA_DOC_13_AI_PROMPTS_LIBRARY
type: prompts_library
stability: stable
truth_level: certain
owner: brain_core
criticality: P1
...
source: Brain_ReviZeus/13_IA_DOCS/08_AI_PROMPTS_LIBRARY.md
---

# 13 — BIBLIOTHÈQUE DE PROMPTS IA (Gemini intra-app)

## Usage IA
Ensemble des prompts Gemini utilisés par l'app pour générer résumés, QCM, dialogues adaptatifs, feedbacks pédagogiques. À consulter avant de toucher à `GeminiManager`, `DivineDialogueOrchestrator` ou les modules de génération.
