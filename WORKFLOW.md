...
Claude consulte l'arbre de connaissance (AGENTS.md, 00_CONTEXT, 03_CODE_MAP, 06_BLOC_STATUS) et produit :
...
Claude met à jour 06_BLOC_STATUS.md si un bloc avance significativement.
...
❌ Oublier de mettre à jour 06_BLOC_STATUS.md
